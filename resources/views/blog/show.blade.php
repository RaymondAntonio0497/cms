...
@section('header')
<!-- Header -->
<header class="header text-white h-fullscreen pb-80" style="background-image: url({{asset($posts->image)}});"
    data-overlay="9">
    <div class="container text-center">
        ...
        <div class="row h-100">
            <div class="col-lg-8 mx-auto align-self-center">
                ...
                <p><img class="avatar avatar-sm" src="{{ Gravatar::src(asset($posts->image)) }}" alt="..."></p>
...
<main class="main-content">
    ...
    <div class="section" id="section-content">
        <div class="container">
            {!! $posts->content !!}
            <div class="addthis_inline_share_toolbox_dztb"></div>
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    <div class="gap-xy-2 mt-6">
                        @foreach($posts->tags as $t)
                            <a class="badge badge-pill badge-secondary" href="{{ route('blog.tag', $t->id) }}">{{$t->name}}</a>
                        @endforeach
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <script>
                    ...
                    *  LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables*/
                    ...
                    s.src = 'https://saas-blog-yno1k15bnq.disqus.com/embed.js';
